 ...
 *  @date 2015.05.05
 *  @version 1.0.1
 *  @roobject ROCK.util.Listener
 *  @roname ROCK.util.Listener
 *  @example
        A模块内监听'com.myTest'频道下的say事件
        ROCK.core.Listener.on('com.myTest', 'say', function(d){alert(d);});
        
        B模块内触发'com.myTest'频道下的say事件
        ROCK.core.Listener.trigger('com.myTest', 'say', 'Hello World!');
 */
(function() {
     ...
     * 
	 * @roobject ROCK.util.Listener
	 * @roname ROCK.util.Listener.once
	 ...
	 * @example
	        A模块内监听'com.myTest'频道下的say事件
	        ROCK.core.Listener.once('com.myTest', 'say', function(d){alert(d);});
     */
     ...
     * 
	 * @roobject ROCK.util.Listener
	 * @roname ROCK.util.Listener.trigger
	 ...
	 * @example
	        B模块内触发'com.myTest'频道下的say事件
	        ROCK.core.Listener.off('com.myTest', 'say', 'Hello World!');
     */
        ...
        if (channelList[channel] && channelList[channel][type] && channelList[channel][type].length) {
            ...
            for (var i = taskList.length; i--;) {
                ...
                if ((callback == null &&  context == null) || 
                    (callback == null &&  context != null  && handler.context === context) || 
                    (handler.func === callback && handler.context === context)) {
                    taskList.splice(i, 1);
                }
            }
        }
    ...
    ROCK.core.Listener = ROCK.core.Listener || that;
})();
;
ROCK = window.ROCK || {};
ROCK.util = ROCK.util || {};
